...
//	对创建这个对象的过程进行封装，外界只需要传输必要的约定参数，返回值就是对象实体
	...
	public  ElementObj createElement(String str) {//定义字符串的规则
		...
		for(String str1 : split) {//X:3
			...
			switch(split2[0]) {
			case "x": this.setX(Integer.parseInt(split2[1])-7);break;
			case "y":this.setY(Integer.parseInt(split2[1])-7);break;
	...
	public void showElement(Graphics g) {	
		g.setColor(Color.black);// new Color(255,255,255)
